...
jQuery( function( $ ) {
	...
	var wc_checkout_form = {
		...
		init: function() {
			...
			// Payment methods
			this.$checkout_form.on( 'change', 'input[name="payment_method"]', this.payment_method_selected );

			if ( $( document.body ).hasClass( 'woocommerce-order-pay' ) ) {
				this.$order_review.on( 'change', 'input[name="payment_method"]', this.payment_method_selected );
			}
