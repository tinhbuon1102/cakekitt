...
$quotetext = get_post_meta($post->ID, 'cake_quote_text' ,true);
$quoteinfotext = get_post_meta($post->ID, 'cake_quote_info_text' ,true);
?>
...
<div id="post-<?php the_ID(); ?>" <?php esc_attr(sanitize_html_class(post_class('article-post'))); ?>>
	...
	<div class="quote-post">
	 <blockquote><p><?php echo esc_textarea($quotetext);?></p><cite><?php echo esc_html($quoteinfotext);?></cite></blockquote>
	</div>
	<?php } ?>
	...
	<header class="entry-header">
		...
		<div class="entry-meta"><?php do_action('cake_post_meta'); ?></div><!-- .entry-meta -->
