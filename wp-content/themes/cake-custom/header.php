...
<?php 
	$off_duty_date_from = get_option('off_duty_date_from');
	$off_duty_date_to = get_option('off_duty_date_to');
	if ($off_duty_date_to && $off_duty_date_from)
	{
		echo 'var gl_off_duty_date = ["'. $off_duty_date_from .'", "'. $off_duty_date_to .'"];';
	}
	?>
