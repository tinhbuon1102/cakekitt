	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		<?php if ( 1 < count( $available_methods ) ) : ?>
			<ul id="shipping_method">
				...
				<?php endforeach; ?>
				<span class="notice-shipfee notice-message">*上記の配送料金は<strong>目安</strong>となります。<br/>デリバリーの送料は<strong>配送地域によって異なります</strong>ので、ご注文後に金額が確定いたします。<br/><span class="red">※配送可能エリア：全国（宅配便にて配送できる場所のみ、受け付けております）</span></span>
			</ul>
