...
function kitt_woocommerce_admin_order_data_after_order_details($order)
{
	...
	if ($shipping_method['method_id'] == KITT_SHIPPING_PICKUP || strpos($shipping_method['method_id'], KITT_SHIPPING_PICKUP) !== false )
	{
		echo '<style>
						...
						<h3 class="input no-interaction text-center display-table width-full"><div class="display-table-cell"><output></output></div></h3>
							<div class="time-range display-table width-full mt-2">
								...
								<div class="display-table-cell">
									<input type="range" id="order_pickup_time" name="cake_custom_order[custom_order_pickup_time]" min="1" max="24" step="0.5" value="9" data-rangeslider />
								</div>
