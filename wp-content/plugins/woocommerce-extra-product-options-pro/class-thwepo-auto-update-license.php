...
if ( ! class_exists( 'THWEPO_Auto_Update_License' ) ) {
	class THWEPO_Auto_Update_License {
		...
		public function __construct( $file, $software_title, $software_version, $plugin_or_theme, $api_url, $text_domain, $extra ) {
			...
			if ( is_admin() ) {
				...
				$this->thpl_license_setting_page = admin_url('edit.php?post_type=product&page=th_extra_product_options_pro&tab=license_settings');
		...
		public function create_software_api_url( $args ) {
			$query_string = apply_filters('thwepo_api_license_query_string', http_build_query( $args, null, '&' ), $args);
