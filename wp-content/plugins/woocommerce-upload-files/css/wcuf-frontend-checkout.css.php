...
.wcuf_upload_fields_row_element 
{
  ...
  margin-right: 40px;
  margin-bottom: 25px;
  width: <?php if($_GET['css_checkout_page_multiple_upload_fields_per_row'] == 'yes' ) echo $_GET['css_checkout_page_upload_field_width'].$_GET['css_checkout_page_upload_field_width_type']; else echo "100%";; ?>;
  overflow:hidden;
  /* background: #FbFbFb; */
  padding: 15px;
  overflow: hidden;
