...
?>
    <div class="scfp-form-row scfp-form-row-radio<?php echo !empty($css_class) ? ' '.$css_class : '';?>">
        ...
        ?>  
            <div class="scfp-form-row-radio-row">
                <input <?php echo $atts;?> type="radio" id="scfp-<?php echo $key; ?>-<?php echo $k;?>" name="scfp-<?php echo $key; ?>[]" <?php if ( !empty( $required ) && !empty($formSettings['html5_enabled']) && (count($choices_list) == 1) ) : ?> required <?php endif;?> <?php checked( in_array($k, $selected_values) );?> value="<?php echo $k;?>"/>            
