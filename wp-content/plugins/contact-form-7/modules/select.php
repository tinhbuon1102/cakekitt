...
function wpcf7_select_form_tag_handler( $tag ) {
	...
	$html = sprintf(
		'<span class="wpcf7-form-control-wrap %1$s"><div class="wpcf7-select-parent"><select %2$s>%3$s</select>%4$s<div class="select-arrow icon-outline-kitt_icons_arrow_down"></div></div></span>',
...
<div class="insert-box">
	<input type="text" name="select" class="tag code" readonly onfocus="this.select()" />
