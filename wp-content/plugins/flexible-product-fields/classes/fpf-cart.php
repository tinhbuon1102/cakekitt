...
class FPF_Cart {
	...
	/**
	 * Plugin
	 * @var Flexible_Product_Fields|null
	 */
	 ...
	 */
    public function __construct( Flexible_Product_Fields_Plugin $plugin, FPF_Product_Fields $product_fields, FPF_Product $product ) {
        $this->_plugin = $plugin;
            ...
            if ( $this->_fields_types_by_type[$field['type']]['has_options'] ) {
                foreach ( $field['options'] as $option ) {
                    if ( $option['value'] == $ret['value'] ) {
                        ...
                        if ( $this->_fields_types_by_type[$field['type']]['has_price_in_options'] ) {
