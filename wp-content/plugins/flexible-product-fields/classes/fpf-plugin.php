...
class Flexible_Product_Fields_Plugin extends \WPDesk\PluginBuilder\Plugin\AbstractPlugin implements \WPDesk\PluginBuilder\Plugin\HookableCollection {
	...
	private function load_dependencies() {
		...
		$this->fpf_product        = new FPF_Product( $this, $this->fpf_product_fields );
		$this->fpf_cart           = new FPF_Cart( $this, $this->fpf_product_fields, $this->fpf_product );
	...
	public function links_filter( $links ) {
		...
		if ( ! wpdesk_is_plugin_active( 'flexible-product-fields-pro/flexible-product-fields-pro.php' ) ) {
			$plugin_links[] = '<a href="' . $pro_link . '?utm_source=' . $utm_source . '&utm_medium=' . $utm_medium . '&utm_campaign=upgrade-quick-link" target="_blank" style="color:#d64e07;font-weight:bold;">' . __( 'Upgrade', 'flexible-shipping' ) . '</a>';
		}
