...
if ( ! class_exists( 'WPDesk_Settings_1_2' ) ) {

	if ( ! class_exists( 'WPDesk_S214_Settings_1_2' ) ) {
	 ...
	 *
	 */
     class WPDesk_Settings_1_2 extends WPDesk_S214_Settings_1_2 {
        ...
        public function __construct( WPDesk_Plugin_1_2 $plugin, $slug = 'wpdesk-settings', $default_tab = 'general' ) {
