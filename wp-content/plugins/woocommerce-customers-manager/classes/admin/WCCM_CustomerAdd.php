		...
		<div id="wpbody">
			...
			<table class="form-table">
				...
				<tr class="form-field form-required">
					<th scope="row"><label for="user_login"><?php _e('Username', 'woocommerce'); ?> <span class="description">(<span class="field_required"><label for="user_login"><?php _e('required', 'woocommerce'); ?></span>)</span></label></th>
				...
				<tr class="form-field">
					<th scope="row"><label for="pass1"><?php _e('Password', 'woocommerce'); ?> <span class="description">(<?php if($this->edit_mode == true) _e('Leaving it blank will leave password unchanged', 'woocommerce-customers-manager'); else _e('Required', 'woocommerce');  ?>)</span></label></th>
					<td>
				...
				<tr class="form-field">
					<th scope="row"><label for="pass2"><?php _e('Repeat Password', 'woocommerce-customers-manager'); if(!$this->edit_mode) echo '<span class="description"> (必須)</span>' ?> </label></th>
					<td>
				...
				<tr class="form-field">
					<th scope="row"><label for="billing_last_name"><?php _e('Last Name', 'woocommerce'); ?> </label></th>
				...
				<tr>
					<th  scope="row"><label for="billing_email"><?php _e('Email address', 'woocommerce'); ?></label></th>
				...
				<tr  class="wccm-shipping-info">
					<th><h3><?php _e('Shipping info', 'woocommerce'); ?></h3></th>
					<td></td>
				</tr>
				
				<tr  class="wccm-shipping-info">
					<th scope="row"><label for="shipping_last_name"><?php _e('宛名', 'cake'); ?></label></th>
				...
				<tr  class="wccm-shipping-info">
					<th scope="row"><label for="shipping_first_name"><?php _e('店舗名', 'cake'); ?></label></th>
				...
				<tr class="wccm-shipping-info">
					<th scope="row"><label for="shipping_company"><?php _e('担当者', 'cake'); ?></label></th>
				...
				<tr class="form-field wccm-shipping-info">
					<th scope="row"><label for="shipping_postcode"><?php _e('Postcode', 'woocommerce'); ?></label></th>
				...
				<tr class="form-field wccm-shipping-info">
					<th scope="row"><label for="shipping_city"><?php _e('City', 'woocommerce'); ?></label></th>
				...
				<tr class="form-field wccm-shipping-info">
					<th scope="row"><label for="shipping_address_1"><?php _e('Address 1', 'woocommerce'); ?></label></th>
				...
				<tr class="form-field wccm-shipping-info">
					<th scope="row"><label for="shipping_address_2"><?php _e('Address 2', 'woocommerce'); ?></label></th>
				...
				<tr class="form-field wccm-shipping-info" style="display:none;">
				...
				<?php global $wpuef_htmlHelper,$wpuef_user_model;
