	...
	private function render_options_page()
	{
		...
		<div class="wrap">
			...
			<div id="options-container">
				...
				<p>
					<label><?php _e('Map default zoom level');?></label>
				...
				<h3><?php _e('Automatic user conversion', 'woocommerce-customers-manager');?></h3>
				<p>
					...
					<input type="checkbox" name="wccm_general_options[automatic_conversion]" value="true" <?php if(isset($options['automatic_conversion'])) echo 'checked="checked"'; ?>></input>
					<br/><br/>
					<label><?php _e('WCCM has to send an email with login credentials after an automatic conversion?', 'woocommerce-customers-manager');?></label>
