	...
	public function remove_translated_id($items_array, $post_type = "product")
	{
		...
		foreach($items_array as $item)	
		{
			...
			if(function_exists('icl_object_id'))
				$item_translated_id = icl_object_id($item->id, $item->type, false, ICL_LANGUAGE_CODE);
			else
				$item_translated_id = apply_filters( 'wpml_object_id', $item->id, $item->type, false, ICL_LANGUAGE_CODE );
