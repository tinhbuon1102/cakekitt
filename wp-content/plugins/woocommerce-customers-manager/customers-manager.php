...
{ 
    ...
    $wccm_customer_list_page =  add_menu_page( 'WooCommerce Customers Manager Page', __('顧客リスト', 'woocommerce-customers-manager'), 'manage_woocommerce', 'woocommerce-customers-manager', 'wccm_load_view',  'dashicons-id' , (string)$place);
	...
	if (current_user_can('level_10')){
	 ...
	 add_submenu_page('woocommerce-customers-manager', __('Options','woocommerce-customers-manager'), __('Options','woocommerce'), 'manage_woocommerce', 'wccm-options-page', 'wccm_render_wppas_option_page');
